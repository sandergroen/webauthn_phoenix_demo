defmodule WebauthnPhoenixDemo.AccountsTest do
  use WebauthnPhoenixDemo.DataCase

  alias WebauthnPhoenixDemo.Accounts

  describe "users" do
    alias WebauthnPhoenixDemo.Accounts.User
  ...
  describe "credentials" do
    ...
    @valid_attrs %{external_id: "some external_id", public_key: "some public_key"}
    @update_attrs %{
      external_id: "some updated external_id",
      public_key: "some updated public_key"
    }
    @invalid_attrs %{external_id: nil, public_key: nil}
    ...
    test "create_credential/1 with valid data creates a credential" do
      ...
      assert credential.external_id == "some external_id"
    ...
    test "update_credential/2 with valid data updates the credential" do
      ...
      assert credential.external_id == "some updated external_id"
